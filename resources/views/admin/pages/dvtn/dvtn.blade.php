		...
		<div class="img-tv mt-3">
			...
			@if(isset($getsk_dvtn) && !empty($getsk_dvtn))
				@foreach($getsk_dvtn as $sk)
					<div class="card">
					   <a href="{{route('admin.dvtn.sk.infosk',['IDSK'=>$sk->IDSK])}}"> <img class="card-img-top" width ="342" height="150" src="http://localhost/project-map-beta2/resources/upload/dvtn/volunteer.jpg" alt="Card image cap"></a>
					    <div class="card-block">
			...
			@else
			  <div class="card">
			    <a href="{{route('admin.dvtn.sk.create')}}"><img class="card-img-top" width ="342" height="150" src="http://localhost/project-map-beta2/resources/upload/dvtn/volunteer.jpg" alt="Card image cap"></a>
			    <div class="card-block">
			    <a href="{{route('admin.dvtn.sk.create')}}">  <h4 class="card-title">Tạo sự kiện</h4></a>
			  ...
			  <div class="card">
			    <a href="{{route('admin.dvtn.sk.create')}}"><img class="card-img-top" width ="342" height="150" src="http://localhost/project-map-beta2/resources/upload/dvtn/volunteer1.png" alt="Card image cap"></a>
			    <div class="card-block">
			    <a href="{{route('admin.dvtn.sk.create')}}">  <h4 class="card-title">Tạo sự kiện</h4></a>
			      <p class="card-text">Sự kiên mới nhất của bạn sẽ được hiển thị tại đây ngay khi bạn tạo sự kiện</p>
			    </div>
			  ...
			  <div class="card">
			    <a href="{{route('admin.dvtn.sk.create')}}"><img class="card-img-top" width ="342" height="150" src="http://localhost/project-map-beta2/resources/upload/dvtn/volunteer2.jpg" alt="Card image cap"></a>
			    <div class="card-block">
			    <a href="{{route('admin.dvtn.sk.create')}}">  <h4 class="card-title">Tạo sự kiện</h4></a>
			      <p class="card-text">Sự kiên mới nhất của bạn sẽ được hiển thị tại đây ngay khi bạn tạo sự kiện</p>
			    </div>
